...
<style>
    body {
            background-image: url('petpic3.avif'); /* Replace with your image path */
...
<div class="container w-1/3"> <!-- Adjusted width here -->
    ...
    <form method="post" class="form-container bg-white p-8 mt-4 shadow-md">
        ...
        <div class="text-center mt-4">
           <button class="bg-red-500 px-12 py-2 text-black mt-2 uppercase hover:bg-red-700" name="login">Login</button>
        </div>
    </form>
</div>
</body>
