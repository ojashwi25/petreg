...
<style>
        ...
        body {
            background-image: url('ppp.webp'); /* Replace with your image path */
...
<div class="container w-1/2 mt-12">
    <p class="text-center uppercase text-orange-500 font-bold text-sm">New Here</p>
    <h1 class="text-center text-3xl font-bold my-2">Register Now</h1>
    ...
    <div class="row flex mt-2">
        ...
        <button class="bg-orange-500 px-12 py-2 text-black mt-2 uppercase hover:bg-orange-700" name="login">Login</button>
            </div>
        </div>
    </form>
